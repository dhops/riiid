...
class MF(nn.Module):
    ...
    def __init__(self, n_user, n_item, n_rank, k=10, kt=2, c_vector=1.0, c_bias=1.0, c_temp=1.0, c_ut=1.0,
                 writer=None):
        """
    ...
    def __call__(self, train_x):
        ...
        prediction = ui_interaction + ut_interaction + biases
        return prediction
    ...
    def loss(self, prediction, target):
        ...
        total = loss_mse + prior_user + prior_item + prior_ut + \
                prior_bias_item + prior_bias_user + prior_tv
